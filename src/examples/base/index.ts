...
export function runExamples(): void {
    ...
    broadcastToAll('broadcast to all color string', Color.Blue)
    broadcastToAll('broadcast to all color string', { r: 1, g: 1, b: 1 })
    broadcastToAll('broadcast to all color', Color(0.5, 0.5, 1, 0.75))
    broadcastToColor('broadcast to white', 'White')
    broadcastToColor('broadcast to white color string', 'White', Color.Blue)
    broadcastToColor('broadcast to white color string', 'White', { r: 1, g: 1, b: 1 })
    ...
    logStyle('style', Color.Blue)
    log('style blue', undefined, 'style')
    logStyle('style', { r: 1, g: 1, b: 1 })
    log('style white', undefined, 'style')
    ...
    printToAll('all message with color string', Color.Blue)
    printToAll('all message with color string', { r: 1, g: 1, b: 1 })
    printToColor('color message no color', 'White')
    printToColor('color message with color', 'White', Color(0, 1, 0))
    printToColor('color message with color string', 'White', Color.Blue)
    printToColor('color message with color string', 'White', { r: 1, g: 1, b: 1 })
    /*
